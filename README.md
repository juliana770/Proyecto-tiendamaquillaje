...
git clone https://github.com/tu-usuario/glamour-store.git

# Navegar al directorio
cd glamour-store

# Abrir en navegador
# Simplemente abre index.html con tu navegador preferido
```
...
Edita el archivo `script.js` en la línea 508:

```javascript
// Reemplaza con tu número de WhatsApp (código de país + número)
const numeroWhatsApp = '59171234567'; // Formato: sin espacios ni símbolos
```
...
Los productos se encuentran en `script.js` desde la línea 1. Puedes modificar:
...
```javascript
{
    ...
    precio: 99.99,
    categoria: "ojos", // ojos, labios, rostro, sombras, perfumes
